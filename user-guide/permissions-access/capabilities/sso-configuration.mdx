...
Single Sign-On (SSO) allows your team members to log into Clara using your organization's identity provider. This provides:
...
- Admin access to Clara workspace

<Note>
**For self-hosting users willing to set up SSO**, reach out to contact@get-clara.tech
</Note>
...
- Remove them from the Clara workspace
...
- **Group mapping**: Map IdP groups to Clara roles (if available)
- **Offboarding process**: Include Clara in your deprovisioning workflow

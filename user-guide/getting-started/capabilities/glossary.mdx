---
title: Glossary
description: Get familiar with essential terminology used in Clara.
---

## API
API (Application Programming Interface) allows you to connect Clara with other software systems and build custom integrations.
...
## Opportunities
Opportunities in Clara CRM are potential deals or sales with accounts or contacts.
...
## Tasks
Tasks in Clara CRM are assigned activities relating to contacts, accounts, or opportunities.
...
## Webhooks
Webhooks are automated messages sent from Clara to other applications when specific events occur, enabling real-time data synchronization.
...
## Workspace
A `Workspace` typically represents a company using Clara. It holds all the records and data that you and your team members add to Clara.
It has a single domain name, which is typically the domain name your company uses for employee email addresses.

## Workspace Members
Workspace Members are the Clara users from your team who have access to your workspace. They can be assigned as owners or assignees for records.

...
The command menu gives you **quick access to actions** in Clara. You can access it in two ways:
...
- Create new views
- Access deleted records (Clara supports soft and hard deletes)

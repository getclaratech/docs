...
description: Follow a step-by-step guide on how to register on Clara, choose a subscription plan, and set up your account.
---

import { VimeoEmbed } from '/snippets/vimeo-embed.mdx';

## Step 1: Registration
1. Navigate to [Clara Sign Up](https://app.get-clara.tech).
...
## Support
For queries or help, connect with the dedicated support team at [contact@get-clara.tech](mailto:contact@get-clara.tech) or send a message on [Discord](https://discord.gg/cx5n4Jzs57).

...
description: Step-by-step guide to migrate your Clara self-hosted instance to Clara Cloud.
---

## Overview

This guide walks you through migrating your data from a Clara self-hosted instance to Clara Cloud. The process involves setting up your cloud workspace, exporting your data, and re-importing it.
...
1. Go to [app.get-clara.tech](https://app.get-clara.tech) and create a new workspace
...
For complex migrations or large datasets, contact us at [contact@get-clara.tech](mailto:contact@get-clara.tech) or explore our [Implementation Services](/user-guide/getting-started/capabilities/implementation-services).

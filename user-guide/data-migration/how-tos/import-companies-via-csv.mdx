...
description: Complete step-by-step guide to importing companies into Clara.
---

## Overview

This guide walks you through importing your companies into Clara. **Companies should be imported first** because People and Opportunities link to Companies.
...
<Note>
**Pro tip:** Click **Download sample file** during import to see the exact column names Clara expects.
</Note>
...
|-------|-------|----------|
| **Duplicate domain** | Domain already exists in Clara | Remove from file or update existing record |
...
<AccordionGroup>
  <Accordion title="Why can't two Companies have the same domain?">
    Domain is a unique identifier in Clara. This prevents duplicate companies and ensures email sync correctly links emails to the right company.
  </Accordion>
  ...
  <Accordion title="What happens if I import a domain that already exists?">
    If you include a unique identifier (domain or id) that matches an existing company, Clara updates that company instead of creating a duplicate.
  </Accordion>

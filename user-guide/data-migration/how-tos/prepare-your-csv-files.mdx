...
description: Complete step-by-step guide to format your data for import into Clara.
---
...
**This is the most important step.** The sample file shows you the exact column names and format Clara expects.
...
Clara enforces uniqueness on certain fields. Duplicates will cause import errors.
...
3. Check for duplicates that already exist in Clara
...
- Must be unique (no duplicates in file or in Clara)
...
- Must be unique within your file and in Clara
...
### Links/URL Fields
Fill both columns:
- **Links / Link Label**: `Clara`
- **Links / Link URL**: `https://get-clara.tech`

For secondary links, use the **Links / Secondary Links** column:
```
[{"url":"https://get-clara.tech","label":"Clara"}]
```
...
### ID Fields
- **Optional**: Clara auto-generates IDs if not provided
...
- The parent record must already exist in Clara
...
## Step 6: Ensure Fields Exist in Clara

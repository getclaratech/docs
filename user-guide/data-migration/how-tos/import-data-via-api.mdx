...
description: When and how to use Clara's APIs for large-scale data imports.
---

## Overview

Clara provides both **GraphQL** and **REST APIs** for programmatic data import. Use the API when CSV import isn't practical for your data volume or when you need automated, recurring imports.
...
Clara enforces rate limits to ensure system stability:
...
- Verify formats match Clara's requirements (see [Field Mapping](/user-guide/data-migration/capabilities/field-mapping))
...
- Verify data appears correctly in Clara
...
Contact us at [contact@get-clara.tech](mailto:contact@get-clara.tech) or explore our [Implementation Services](/user-guide/getting-started/capabilities/implementation-services).

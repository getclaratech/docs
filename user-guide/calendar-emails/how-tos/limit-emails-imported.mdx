...
description: Control which emails are imported into Clara.
---

## Overview

By default, Clara syncs all external emails from your connected mailbox. You can limit what gets imported using **folder selection** and **visibility settings**.

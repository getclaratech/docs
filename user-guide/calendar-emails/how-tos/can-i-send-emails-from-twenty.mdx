---
title: Can I Send Emails from Clara?
description: Information about sending emails directly from Clara.
---

## Current Status

Clara's email integration is designed to **sync and display** your email history. Emails cannot be composed or sent directly from Clara's interface.
...
While you can't send emails manually from Clara, you **can send emails automatically using Workflows**. This is useful for:
...
For email sequences and newsletters, we recommend using workflows to connect Clara to a dedicated email marketing tool.
...
Native email composition from within Clara is on our roadmap. Join our [GitHub discussions](https://github.com/getclaratech/clara/discussions) to share your use case and help prioritize this feature.

...
description: Learn about the actions available in Clara workflows.
---
...
<Note>
You can only send emails from mailboxes synced to your own Clara account. Sending from other team members' mailboxes (e.g., the account owner's email) is on the roadmap.
</Note>

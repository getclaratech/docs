...
| **Custom integrations** | Your app → Clara automation |
...
3. You'll receive a unique webhook URL like:
   ```
   https://{your-workspace-url}/webhooks/workflow/abc123...
   ```
...
**Using cURL**:
```bash
curl -X POST https://{your-workspace-url}/webhooks/workflow/abc123... \

---
title: Generate a PDF from Clara
description: Create a workflow to generate and attach a PDF (such as a quote) to a record.
---

Automatically generate or fetch a PDF and attach it to a record in Clara. This is commonly used to create quotes, invoices, or reports that are linked to Companies, Opportunities, or other objects.
...
export const main = async (
  ...
  // Replace with your Clara GraphQL endpoints (/metadata for metadata and files or /graphql for your records)
  // Hosted workspace: https://{your-workspace-url}/graphql
  // Self-hosted: https://your-domain.com/graphql

  const metadataGraphqlEndpoint = 'https://{your-workspace-url}/metadata';
  const dataGraphqlEndpoint = 'https://{your-workspace-url}/graphql';
...
- [Generate a Quote or Invoice from Clara](/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-twenty)

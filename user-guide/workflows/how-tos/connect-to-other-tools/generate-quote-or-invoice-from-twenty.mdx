---
title: Generate a Quote or Invoice from Clara
...
- [Generate a PDF from Clara](/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — attach generated PDFs to records

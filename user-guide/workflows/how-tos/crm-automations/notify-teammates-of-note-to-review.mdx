...
You want to tag a colleague in a note so they receive a notification to review it. Today, Clara doesn't support @mentions in notes or tasks.
...
View the note here:
https://your-workspace-url/object/note/{{recordIsUpdated.id}}
...
<Note>
Replace `your-workspace-url` with your actual Clara workspace URL.
</Note>

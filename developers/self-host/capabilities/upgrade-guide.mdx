...
Starting from **v1.22**, Clara supports cross-version upgrades. You can jump directly from any supported version to the latest release without stepping through each intermediate version.

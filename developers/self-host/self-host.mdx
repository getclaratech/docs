---
title: Self-Host
description: Deploy and manage Clara on your own infrastructure.
---
<Frame>
...
Clara can be self-hosted on your own infrastructure, giving you full control over your data and deployment.

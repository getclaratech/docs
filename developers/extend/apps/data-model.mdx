---
title: Data Model
description: Define objects, fields, roles, and application metadata with the Clara SDK.
icon: "database"
---
...
export default defineApplication({
  ...
  displayName: 'My Clara App',
  description: 'My first Clara app',
  icon: 'IconWorld',
...
export default defineRole({
  ...
  description: 'Default role for function Clara client',
...
- See a working example: [`hello-world/src/roles/function-role.ts`](https://github.com/getclaratech/clara/blob/main/packages/twenty-apps/hello-world/src/roles/function-role.ts).
...
<Note>
**Base fields are created automatically.** When you define a custom object, Clara automatically adds standard fields
...
Relations connect objects together. In Clara, relations are always **bidirectional** — you define both sides, and each side references the other.

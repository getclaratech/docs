...
icon: "rocket"
description: Create your first Clara app in minutes.
---
...
<div style={{textAlign: 'center'}}>
  <img src="/images/docs/developers/extends/apps/login.png" alt="Clara login screen" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src="/images/docs/developers/extends/apps/authorize.png" alt="Clara CLI authorization screen" />
</div>

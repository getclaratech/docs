---
title: Layout
description: Define views, navigation menu items, and page layouts to shape how your app appears in Clara.
icon: "table-columns"
---

Layout entities control how your app surfaces inside Clara's UI — what lives in the sidebar, which saved views ship with the app, and how a record detail page is arranged.

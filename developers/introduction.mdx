...
<CardGroup cols={3}>
  <Card
    ...
    img="/images/user-guide/halftone/dev-apps.png"
  >
    <CardTitle>Apps</CardTitle>
    Extend Clara with custom objects, server-side logic, UI components, and
    AI-assisted workflows — all as TypeScript packages.
  </Card>
  <Card
  ...
  >
    ...
    Run Clara on your own infrastructure.
  </Card>
  <Card
    href="/developers/contribute/capabilities/local-setup"
    img="/images/user-guide/halftone/dev-contribute.png"
  >

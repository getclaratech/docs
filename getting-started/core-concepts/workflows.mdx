---
title: Workflows
description: Automate your business processes with Clara's visual workflow builder.
icon: "bolt"
---

Workflows let you automate repetitive tasks and connect Clara to external tools — without writing code (though you can if you want to).
...
- Sync data between Clara and your billing system

...
for lang_dir in "$DOCS_DIR"/*/ ; do
  ...
  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|https://docs\.twenty\.com/user-guide/|https://docs.get-clara.tech/l/$lang_code/user-guide/|g" {} \;
  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|https://docs\.twenty\.com/developers/|https://docs.get-clara.tech/l/$lang_code/developers/|g" {} \;
  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|https://docs\.twenty\.com/twenty-ui/|https://docs.get-clara.tech/l/$lang_code/twenty-ui/|g" {} \;

  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|https://docs\.twenty\.com/user-guide/|https://docs.get-clara.tech/$lang_code/user-guide/|g" {} \;
  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|https://docs\.twenty\.com/developers/|https://docs.get-clara.tech/$lang_code/developers/|g" {} \;
  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|https://docs\.twenty\.com/twenty-ui/|https://docs.get-clara.tech/$lang_code/twenty-ui/|g" {} \;
